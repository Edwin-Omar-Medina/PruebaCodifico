...
public partial class StoreSampleContext : DbContext
{
    ...
    public virtual DbSet<NextPredictedOrder> NextPredictedOrders { get; set; }
    ...
    public virtual DbSet<TotalEmployee> TotalEmployees { get; set; }

    public virtual DbSet<TotalProduct> TotalProducts { get; set; }

    public virtual DbSet<TotalShipper> TotalShippers { get; set; }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
   // => optionsBuilder.UseSqlServer("Server=EDWINMEDINA; DataBase=StoreSample; Integrated Security=true; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TotalEmployee>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("TotalEmployees", "HR");
        ...
        modelBuilder.Entity<TotalProduct>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("TotalProducts", "Production");
        ...
        modelBuilder.Entity<TotalShipper>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("TotalShippers", "Sales");
    ...
    /*public async Task<int> InsertOrderWithDetailsAsync(InsertOrderWithProduct input)
    {
        var result = await Database.ExecuteSqlRawAsync(
            "EXEC Sales.InsertOrderWithProduct @custid = {0}, @empid = {1}, @orderdate = {2}, @requireddate = {3}, @shippeddate = {4}, @shipperid = {5}, @freight = {6}, @shipname = {7}, @shipaddress = {8}, @shipcity = {9}, @shipcountry = {10}, @productid = {11}, @unitprice = {12}, @qty = {13}, @discount = {14}",
            input.CustId,
            input.EmpId,
            input.OrderDate,
            input.RequieredDate,
